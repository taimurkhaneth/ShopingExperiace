...
async function startShopping() {
    ...
    if (shopCont === "Yes") {
        startShopping(); // Recursive call to continue shopping
    }
    else {
        bill();
    }
...
async function vegetables() {
    ...
    for (let i = 0; i < itemnumber.userChoice; i++) {
        ...
        itemsquaV.push(thirdInput.userChoice);
        let bill = thirdInput.userChoice * items2[secondInput.userChoice].price;
        billSumV.push(bill);
    }
}
// Fruits function
async function Fruits() {
    ...
    for (let i = 0; i < itemnumber.userChoice; i++) {
        ...
        let bill = Number(thirdInput.userChoice) * items[secondInput.userChoice].price;
        billSumF.push(bill);
    }
}
